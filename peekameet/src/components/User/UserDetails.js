    ...
    <>
      <div className="upperContainer">
        ...
        <p className="upperpara">
          ...
          suscipit vulputate mollis, mi dolor bibendum mi, non auctor nisi est
          nec nunc. More
        </p>
        <div className="displayData">
          <div className="industry">
            ...
            <span className="fine">
              {userCtx.userData.data[0].customer.industry[0]}
            </span>
          </div>
          <div className="groups">
            <p className="displayPara">Organizations and Groups</p>
            <span className="iaw">IAW</span>
            <span className="rugby">
              {userCtx.userData.data[0].customer.organisationGroups[0]}
            </span>
          </div>
          <div className="interests">
            ...
            <span className="guitar">
              {userCtx.userData.data[0].customer.interestActivities[0]}
            </span>
          </div>
          <div className="alumni">
            ...
            <span className="uc">
              {userCtx.userData.data[0].customer.alumni[0]}
            </span>
          </div>
          <div className="languages">
            <p className="displayPara">Languages</p>
            <span className="english">
              {userCtx.userData.data[0].customer.languages[0]}
            </span>
        ...
        <div className="address">
          ...
          <p className="digital">
            {userCtx.userData.data[0].customer.businessAddress}
          </p>
          <p className="sycamore">123 Sycamore Dr</p>
          <p className="torrington">
            Torrington CT, {userCtx.userData.data[0].customer.businessPhone}
          </p>
        </div>
      </div>
    </>
