...
<div className="navItems">
            ...
            <div className="col-md-6">
              <div className="card-body">
                ...
                <div className="card-text pb-3 radiusSection">
                  ...
                  <span className="mompreneur">Mompreneur</span><br/><br/>
                  <span className="intern">Internship Seeker</span>
                  <span className="environment">Environmental Change Maker</span>
                  {/* Mounting, Updating, and Unmounting. */}
                </div>
                <p className="card-text buildText">Build and manage your network with PEEKaMEET</p>
              </div>
  ...
  <div class="form-group">
    <label for="pwd" className="password">Password:</label>
    <input type="password" className="form-control" id="pwd"/>
  </div>
  <button type="submit" className="btn btn-default submit">Sign In</button>
  <div class="checkbox">
    <label><input type="checkbox"/> Remember me</label>
    <span className="forgot">Forgot Password</span>
  </div>
  <div class="signup">
    <p>Don’t have an account? <span className="signupLine">Sign Up</span></p>
  </div>
</form>
