        ...
        <div className="userStuff">
          <h1>
            {userCtx.userDetails &&
              userCtx.userDetails.data &&
              userCtx.userDetails.data[0] &&
              userCtx.userDetails.data[0].customer.name}
          </h1>
          <h3>
            {userCtx.userDetails &&
              userCtx.userDetails.data &&
              userCtx.userDetails.data[0] &&
              userCtx.userDetails.data[0].customer.jobTitle}
          </h3>
          <h4>
            {userCtx.userDetails &&
              userCtx.userDetails.data &&
              userCtx.userDetails.data[0] &&
              userCtx.userDetails.data[0].customer.company}
          </h4>
          <button type="button" className="msg btn1 btn btn-success">
            <img className="msgbtn" src={MsgBtn1} />
            Message
          </button>
          <button type="button" className="msg btn2 btn btn-success">
            <img className="msgbtn" src={MsgBtn2} />
            Save Contact
          </button>
        </div>
      </div>
